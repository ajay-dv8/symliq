...
//         // Calculate horizontal scroll only when section is in view
//         e.preventDefault(); // Prevent default vertical scroll
//         const maxScroll = container.scrollWidth - container.clientWidth;
//         const scrollPercentage =
//           (window.scrollY - section.offsetTop) /
//           (section.scrollHeight - window.innerHeight);
//         container.scrollLeft = maxScroll * Math.max(0, Math.min(1, scrollPercentage));
//       }
//     };
...
//           <div
//             ref={containerRef}
//             className="flex overflow-x-auto no-scrollbar cursor-pointer "
//             style={{ scrollBehavior: "smooth" }}
//           >
//             <div className="flex gap-6 px-8 min-w-max my-4">
...
//                   >
//                     {/* Filter overlay */}
//                     <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-60 transition-opacity duration-300 pointer-events-none w-[(100%+1rem)]" />
