    ...
    (<CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
      <div className="relative w-full">
        ...
        <div className="flex justify-end gap-2 mr-10">
          <button
            className="relative h-10 w-10 rounded-full bg-colorLight flex items-center justify-center disabled:opacity-50"
            onClick={scrollLeft}
    ...
    <motion.button
      ...
      <div className="relative ">
        ...
        <motion.p
          ...
          className="text-white text-xl md:text-2xl font-normal max-w-xs text-left [text-wrap:balance] ~mt-2/4">
          {card.name} 
        </motion.p>
        <motion.p
